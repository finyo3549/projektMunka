...
public class MainViewModel : ViewModelBase
{
    ...
    ///// <summary>
    ///// Gets or sets a value indicating whether the MAinWindow is visible (under development).
    ///// </summary>
    //public bool Visible
    //{
    //    get => _visible;
    ...
    {
        var response = await _userRepository.LogOut(CurrentUser.AuthToken);
        if (response.Success)
        {
    ...
    /// </summary>
    public void ExecuteShowTopicViewCommand()
    {
    ...
    /// </summary>
    public void ExecuteShowRankViewCommand()
    {
    ...
    /// </summary>
    public void ExecuteShowQuestionViewCommand()
    {
    ...
    /// </summary>
    public void ExecuteShowHomeViewCommand()
    {
    ...
    /// </summary>
    public void ExecuteShowUsersViewCommand()
    {
